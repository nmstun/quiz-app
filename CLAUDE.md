...
- カテゴリ(算数/漢字/都道府県/地図記号/なぞなぞ/モビルスーツ/からぴち/スマブラ/達人)と問題数コース(みじかい5問/ふつう10問/ながい20問)を選んで開始
...
- 達人: 算数・漢字・都道府県・地図記号・なぞなぞ・モビルスーツ・からぴち・スマブラを設問ごとにランダムに混ぜて出題
- 回答は音声入力(Web Speech API)、非対応環境ではテキスト入力にフォールバック。モビルスーツ・からぴち・スマブラのみ四択ボタンでの回答形式
