...
- `test.js`の回帰テストで、全カテゴリ・全学年の出題範囲と採点、連打防止、中断時のタイマー停止、四択の正誤マーキング、効果音のオン/オフ、マイク解放、ベストスコアの保存キーを検証(98項目 pass)。からぴちは出題プール122問すべてを実際に出題させ、設問文から正解が一意に引けることを確認している
